...
class DetailWargaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // LOGO BACKGROUND DI TENGAH LAYAR
          // Logo di belakang sudah dihapus dan dipindah ke dalam Card!
                ...
                Transform.translate(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFFFFFFF), // KEMBALI SOLID KARENA LOGO ADA DI DALAM
                      ...
                      child: Stack(
                        children: [
                          // WATERMARK LOGO DI DALAM CARD KREM
                          Positioned.fill(
                            top: 60, // Turunkan sedikit dari area Avatar
                            child: Align(
                              alignment: Alignment.center,
                              child: Opacity(
                                opacity: 0.25, // Cukup pekat karena akan tertutup warna box putih tipis
  ...
  Widget _buildDetailBox(String label, dynamic value) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white.withValues(alpha: 0.65), // TRANSPARAN AGAR LOGO DARI DALAM CARD TEMBUS KUAT
